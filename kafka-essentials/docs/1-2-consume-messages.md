...
As we can see, the message was successfully produced and consumed! 
Let's update our diagram to reflect the complete flow:

![kafka-consumer-end](./img/1-2-consume-msg-end.png)
